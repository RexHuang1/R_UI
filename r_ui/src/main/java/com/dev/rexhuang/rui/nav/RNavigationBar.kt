...
import com.dev.rexhuang.rui.iconc.IconFontButton
import com.dev.rexhuang.rui.iconc.IconFontTextView
 ...
 **  on 2022/7/8
 */
class RNavigationBar@JvmOverloads constructor(
    ...
    fun addLeftTextButton(@StringRes stringRes: Int, viewId: Int): Button {
        return addLeftTextButton(RResUtil.getString(stringRes), viewId)
    }
    ...
    private fun ensureTitleContainer() {
        if (titleContainer == null) {
            ...
            titleContainer?.apply {
                ...
                this@RNavigationBar.addView(titleContainer, params)
            }
        }
    }
