 ...
 * *  on 2020/7/27
 */
public class RNumberIndicator extends FrameLayout implements IRIndicator<FrameLayout> {
    ...
    public RNumberIndicator(@NonNull Context context) {
        this(context,null);
    }

    public RNumberIndicator(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RNumberIndicator(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        mPointLeftRightPadding = RDisplayUtil.dp2px(10, getContext().getResources());
        mPointTopBottomPadding = RDisplayUtil.dp2px(10, getContext().getResources());
    }
